<?php
	 ...
	 */
	 public function run()
     {
	 	...
	 	DB::table('course')->insert([
			'id' => 89,
			'title' => "Incline Dumbbell Press Reverse-Grip",
	 	...
	 	DB::table('course')->insert([
			'id' => 138,
			'title' => "Snatch-Grip Behind-The-Neck Overhead Press",
	 	...
	 	DB::table('course')->insert([
			'id' => 139,
			'title' => "Weighted Suitcase Crunch",
	 	...
	 	DB::table('course')->insert([
			'id' => 273,
			'title' => "Romanian Deadlift with Kettlebell",
	 	...
	 	DB::table('course')->insert([
			'id' => 535,
			'title' => "One-Arm Plank Dumbbell Biceps Curl",
	 	...
	 	DB::table('course')->insert([
			'id' => 555,
			'title' => "Partner Farmer's Walk Competition",
	 	...
	 	DB::table('course')->insert([
			'id' => 801,
			'title' => "Partner Hanging Knee Raise With Manual Resistance",
	 	...
	 	DB::table('course')->insert([
			'id' => 807,
			'title' => "Front-To-Back Squat With Belt",
	 	...
	 	DB::table('course')->insert([
			'id' => 816,
			'title' => "Half-kneeling Dumbbell Shoulder Press",
	 	...
	 	DB::table('course')->insert([
			'id' => 835,
			'title' => "Partner Suitcase Carry Competition",
	 	...
	 	DB::table('course')->insert([
			'id' => 844,
			'title' => "Partner Lying Leg Raise With Lateral Throw Down",
	 	...
	 	DB::table('course')->insert([
			'id' => 851,
			'title' => "Partner Sit-Up With High-Five",
	 	...
	 	DB::table('course')->insert([
			'id' => 854,
			'title' => "Partner Facing Plank With Band Row",
	 	...
	 	DB::table('course')->insert([
			'id' => 855,
			'title' => "Partner Lying Leg Raise With Throw Down",
	 	...
	 	DB::table('course')->insert([
			'id' => 860,
			'title' => "Bench Press With Short Bands",
	 	...
	 	DB::table('course')->insert([
			'id' => 891,
			'title' => "Kettlebell Thruster Progression",
	 	...
	 	DB::table('course')->insert([
			'id' => 892,
			'title' => "Kettlebell 3-Point Extension",
	 	...
	 	DB::table('course')->insert([
			'id' => 899,
			'title' => "Around The World Pull-Up",
	 	...
	 	DB::table('course')->insert([
			'id' => 900,
			'title' => "Plate Shoulder Circle Big To Small Rotation",
	 	...
	 	DB::table('course')->insert([
			'id' => 903,
			'title' => "Decline Explosive Push-Up",
	 	...
	 	DB::table('course')->insert([
			'id' => 919,
			'title' => "Barbell Deadlift Bent Row Complex",
	 	...
	 	DB::table('course')->insert([
			'id' => 920,
			'title' => "V-Sit Dumbbell Triceps Extension",
	 	...
	 	DB::table('course')->insert([
			'id' => 921,
			'title' => "Front Dumbbell Raise Using Towel",
	 	...
	 	DB::table('course')->insert([
			'id' => 922,
			'title' => "Close-Stance Dumbbell Front Squat",
	 	...
	 	DB::table('course')->insert([
			'id' => 947,
			'title' => "Single-Arm Dumbbell Overhead Squat",
	 	...
	 	DB::table('course')->insert([
			'id' => 951,
			'title' => "Partner Hanging Knee Raise With Throw Down",
	 	...
	 	DB::table('course')->insert([
			'id' => 952,
			'title' => "Partner Flat-Bench Back Extension With Hold",
	 	...
	 	DB::table('course')->insert([
			'id' => 954,
			'title' => "Partner Facing Feet-Elevated Side Plank With Band Row",
	 	...
	 	DB::table('course')->insert([
			'id' => 955,
			'title' => "Partner Facing Side Plank With Band Row",
	 	...
	 	DB::table('course')->insert([
			'id' => 956,
			'title' => "Partner Facing Planks With Alternating High-Five",
	 	...
	 	DB::table('course')->insert([
			'id' => 957,
			'title' => "Partner 3-Touch Motion Russian Twist",
	 	...
	 	DB::table('course')->insert([
			'id' => 958,
			'title' => "Partner Side-To-Side Russian Twist & Pass",
	 	...
	 	DB::table('course')->insert([
			'id' => 960,
			'title' => "Partner Flat-Bench Back Extension",
	 	...
	 	DB::table('course')->insert([
			'id' => 969,
			'title' => "Partner Supermans With Alternating High-Five",
	 	...
	 	DB::table('course')->insert([
			'id' => 1030,
			'title' => "Burpee To Medicine Ball Press",
	 	...
	 	DB::table('course')->insert([
			'id' => 1031,
			'title' => "Wide-Stance Jump Squat To Close-Stance",
	 	...
	 	DB::table('course')->insert([
			'id' => 1032,
			'title' => "V-Sit Lying Down Ball Throw And Catch",
	 	...
	 	DB::table('course')->insert([
			'id' => 1034,
			'title' => "Body Triceps Press Using Flat Bench",
	 	...
	 	DB::table('course')->insert([
			'id' => 1035,
			'title' => "Bar Push-Up Smith Machine",
	 	...
	 	DB::table('course')->insert([
			'id' => 1036,
			'title' => "Barbell Front-To-Back Squat",
	 	...
	 	DB::table('course')->insert([
			'id' => 1039,
			'title' => "Dumbbell Alternating Lunge",
	 	...
	 	DB::table('course')->insert([
			'id' => 1041,
			'title' => "Lateral Hop 4 Times To Sprint",
	 	...
	 	DB::table('course')->insert([
			'id' => 1063,
			'title' => "Lateral Hop Holding Dumbbells",
